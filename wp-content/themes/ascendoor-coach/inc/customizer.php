...
function ascendoor_coach_customize_preview_js() {
	wp_enqueue_script( 'ascendoor-coach-customizer', get_template_directory_uri() . '/assets/js/customizer.min.js', array( 'customize-preview' ), ASCENDOOR_COACH_VERSION, true );
}
...
function ascendoor_coach_custom_control_scripts() {
	wp_enqueue_style( 'ascendoor-coach-custom-controls-css', get_template_directory_uri() . '/assets/css/custom-controls.min.css', array(), '1.0', 'all' );
	wp_enqueue_script( 'ascendoor-coach-custom-controls-js', get_template_directory_uri() . '/assets/js/custom-controls.min.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), '1.0', true );
}
